...
const typographyAttrs = useTypographyAttrs({ variant: 'body' });
...
const onFocus = (e: FocusEvent) => {
  ...
  if (!keyboard.isShown && platform.value === 'ios') {
...
<template>
  <component
    ...
    ref="input"
    :class="['list-item-body-left-input-element', typographyAttrs.classes]"
...
<style lang="scss">
.list-item-body-left-input-element {
  border: none;
  ...
  &:not(&:placeholder-shown) + .list-item-body-left-input-placeholder {
    display: none;
  }
}
</style>

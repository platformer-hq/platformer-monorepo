...
export type HomePageDataQuery = { __typename?: 'Query', currentUser: { __typename?: 'CurrentUser', id: string, managementInvites: Array<{ __typename: 'AppManagementInvite' }>, appTransferRequests: Array<{ __typename: 'AppTransferRequest' }> } };

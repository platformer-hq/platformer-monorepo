...
export type AppsPageDataQuery = { __typename?: 'Query', currentUser: { __typename?: 'CurrentUser', apps: Array<{ __typename?: 'UserManagedApp', role: Types.AppRole, app: { __typename?: 'App', id: string, title: string, privacy: Types.AppPrivacy } }>, limits: { __typename?: 'UserLimits', maxOwnedAppsCount?: number | null } } };

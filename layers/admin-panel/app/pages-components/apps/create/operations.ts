...
export type CreateAppMutation = { __typename?: 'Mutation', createApp: { __typename?: 'App', id: string, title: string, privacy: Types.AppPrivacy, currentUserRole: Types.AppRole } };

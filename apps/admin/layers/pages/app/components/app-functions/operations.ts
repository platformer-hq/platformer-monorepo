...
export type AppFunctionsQueryVariables = Types.Exact<{
  appId: Types.Scalars['ID']['input'];
}>;


export type AppFunctionsQuery = {
  __typename?: 'Query',
  app?: {
    __typename?: 'App',

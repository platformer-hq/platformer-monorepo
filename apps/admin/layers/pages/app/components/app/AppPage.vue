...
const { t } = useI18n({
  messages: {
    en: {
      ...
      'common.serverlessFunctions': 'Serverless Functions',
    ...
    ru: {
      ...
      'common.serverlessFunctions': 'Облачные функции',
...
const sections = computed(() => [
  {
    items: [
      ...
      { icon: ServerlessFunctionsIcon, title: t('common.serverlessFunctions'), name: PageNames.AppServerlessFunctions },
    ],
  },
  {

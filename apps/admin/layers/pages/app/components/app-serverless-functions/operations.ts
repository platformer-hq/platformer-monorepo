...
export type AppServerlessFunctionsQuery = { __typename?: 'Query', app?: { __typename?: 'App', currentUserRole: Types.AppRole, limits: { __typename?: 'AppLimits', serverlessFunctions: { __typename?: 'AppServerlessFunctionsLimits', maxCount?: number | null } }, serverlessFunctions: Array<{ __typename?: 'AppServerlessFunction', id: number, name: string, enabled: boolean }> } | null };

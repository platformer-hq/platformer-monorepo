...
/**
 * Describes Telegram Mini Apps [Chat](https://docs.mini-apps.store/platforms/telegram/init-data#chat) type.
 */
...
/**
 * Describes Telegram Mini Apps [InitData](https://docs.mini-apps.store/platforms/telegram/init-data#parameters-list)
 * type.
 */
